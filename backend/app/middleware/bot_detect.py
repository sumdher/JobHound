"""
Lightweight bot / automated-client detection for JobHound.

First-line filter against script-kiddies and naive scanners. Will not stop a
determined attacker who spoofs headers, but eliminates the vast majority of
automated traffic on auth endpoints before rate-limit counters are consumed.

Apply with the `block_bots` dependency on routes that real browsers hit.
"""
